          ...
          <div className="hdr-logo">
            <div className="hdr-logo-icon">
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <rect x="1" y="1" width="5" height="5" rx="1" fill="#FFFFFF"/>
                <rect x="8" y="1" width="5" height="5" rx="1" fill="#FFFFFF"/>
                <rect x="1" y="8" width="5" height="5" rx="1" fill="#FFFFFF"/>
                <rect x="8" y="8" width="5" height="5" rx="1" fill="#FFFFFF" opacity="0.4"/>
              </svg>
            </div>
